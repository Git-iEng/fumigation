...
def request_demo_view(request):
    ...
    subject = "New Green Fumigation Machine inquiry"
    text_body = (
        "A new Green Fumigation Machine inquiry request was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New Green Fumigation Machine Inquiry Request</h2>
