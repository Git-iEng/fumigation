...
def request_demo_view(request):
    ...
    subject = "New Green Fumigation Machine Inquiry Request"
    text_body = (
        "A new Green Fumigation Machine inquiry was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New website contact submission for Green Fumigation Machine</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for Green Fumigation Machine"
        text_body = "\n".join(
            [
                "New contact submission for Green Fumigation Machine:",
